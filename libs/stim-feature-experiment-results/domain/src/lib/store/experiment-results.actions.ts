...
export const actionExperimentResultsAllRequest = createAction('[ExperimentResults] all records request', props<{}>());
...
export const actionExperimentResultsAllRequestFail = createAction('[ExperimentResults] all records request fail', props<{}>());

// One record request
export const actionExperimentResultsEmpty = createAction('[ExperimentResults] empty record', props<{}>());
...
export const actionExperimentResultsOneRequestFail = createAction('[ExperimentResults] one record request fail', props<{}>());

// Insert record request
export const actionExperimentResultsInsertRequest = createAction('[ExperimentResults] insert record request', props<{ experimentResult: ExperimentResult }>());
...
export const actionExperimentResultsInsertRequestFail = createAction('[ExperimentResults] insert record request fail', props<{}>());
...
export const actionExperimentResultsUpdateRequestFail = createAction('[ExperimentResults] update record request fail', props<{}>());
...
export const actionExperimentResultsDeleteRequestFail = createAction('[ExperimentResults] delete record request fail', props<{}>());
...
export const actionExperimentResultsNameExistsRequestFail = createAction('[ExperimentResults] name exists request fail', props<{}>());
