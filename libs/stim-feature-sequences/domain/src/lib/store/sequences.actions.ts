...
export const actionSequencesOneRequestFail = createAction('[Sequences] one record request fail');
...
export const actionSequencesInsertRequestFail = createAction('[Sequences] insert record request fail');
...
export const actionSequencesUpdateRequestFail = createAction('[Sequences] update record request fail');
...
export const actionSequencesDeleteRequestFail = createAction('[Sequences] delete record request fail');
...
export const actionSequencesNameExistsRequestFail = createAction('[Sequences] name exists request fail');

// Sequence specific actions

// Generate new sequence for selected experiment
export const actionSequencesGenerateRequest = createAction('[Sequences] generate new sequence request', props<{ sequence: Sequence }>());
...
export const actionSequencesGenerateFail = createAction('[Sequences] generate new sequence request fail');

// Get all experiments as sequence providers
export const actionSequencesExperimentsAsSequenceSourceRequest = createAction('[Sequences] find sequences for experiments as sequence source');
...
export const actionSequencesExperimentsAsSequenceSourceRequestFail = createAction('[Sequences] find sequences for experiments as sequence source fail');

export const actionSequencesOriginalAsActual = createAction('[Sequences] replace original sequence as actual');

export const actionSequencesUpdateSelectedExperiment = createAction('[Sequences] update selected experiment');

export const actionSequencesToggleSelected = createAction('[Sequences] toggle sequence entry selected', props<{ sequence: Sequence }>());

export const actionSequencesSelectAll = createAction('[Sequences] select all sequences');
export const actionSequencesSelectNone = createAction('[Sequences] deselect all sequences');

export const actionSequencesNoAction = createAction('[Sequences] no action');
