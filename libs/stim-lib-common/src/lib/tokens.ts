...
export const TOKEN_EXPERIMENTS_API_URL = new InjectionToken(
  'TOKEN_EXPERIMENTS_API_URL'
);
export const TOKEN_EXPERIMENT_RESULTS_API_URL = new InjectionToken(
  'TOKEN_EXPERIMENT_RESULTS_API_URL'
);
export const TOKEN_SEQUENCES_API_URL = new InjectionToken(
