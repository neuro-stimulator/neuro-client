...
export function navigationReducer(navigationState: NavigationState, navigationAction: Action) {
  return createReducer(
    ...
    on(NavigationActions.actionToggleSidebar, (state: NavigationState) => ({
      ...state,
    ...
    on(NavigationActions.actionSetShowAddon, (state: NavigationState, action) => ({
      ...state,
...
export const navigationFeature = createFeatureSelector<NavigationState>(navigationReducerKey);
