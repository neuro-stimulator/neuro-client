...
import { createEmptyExperiment, Experiment, MessageCodes, Output, ResponseObject } from '@stechy1/diplomka-share';

import { ExperimentsService } from './experiments.service';

function prepareMockExperiments(): Experiment<Output>[] {
...
describe('ExperimentsService', () => {
  ...
  // let mockExperiments: Experiment<Output>[];
  //
  // beforeEach(() => {
  ...
  //   expect(service.all()).resolves.toBe(mockExperiments.length);
  //
  ...
  //   const resp: ResponseObject<Experiment<Output>[]> = {data: mockExperiments};
  ...
  //     const experiment: Experiment<Output> = mockExperiments[1];
  //     // Výsledek dotazu má být hledaný experiment
  //     expect(service.one(experiment.id)).resolves.toBe(experiment);
  //
  ...
  //     const resp: ResponseObject<Experiment<Output>> = {data: experiment};
  //     // Ručně odešlu odpověď
  //     req.flush(resp);
  //   });
  //
  ...
  //     const id = 9;
  //     expect(service.one(id)).rejects.toThrowError();
  //
  //     // Založím nový požadavek
  ...
  //     expect(req.request.body).toBeNull();
  //     // Přípravím si odpověď s namockovaným experimentem
  //     const resp: ResponseObject<Experiment<Output>> = { message: { code: MessageCodes.CODE_ERROR_EXPERIMENT_NOT_FOUND, params: { id } }};
  //     // Ručně odešlu odpověď
  //     req.flush(resp);
  //   });
  //
  ...
  //   const responseExperiment: Experiment<Output> = {...experiment};
  ...
  //   expect(service.insert(experiment)).resolves.toBe(responseExperiment);
  //
  //   // Založím nový požadavek
  //   const req: TestRequest = httpTestingController.expectOne(`${ExperimentsService.BASE_API_URL}`);
  ...
  //   // Přípravím si odpověď s namockovaným experimentem
  //   const resp: ResponseObject<Experiment<Output>> = { data: responseExperiment };
  //   // Ručně odešlu odpověď
  //   req.flush(resp);
  // });
  //
  ...
  //   expect(service.insert(experiment)).resolves.toBeUndefined();
  //
  //   // Založím nový požadavek
  //   const req: TestRequest = httpTestingController.expectOne(`${ExperimentsService.BASE_API_URL}`);
  //   // Požadavek bude typu GET
  ...
  //   expect(req.request.body).toBe(experiment);
  //   // Přípravím si odpověď s namockovaným experimentem
  //   const resp: ResponseObject<Experiment<Output>> = { message: { code: -1 } };
  //   // Ručně odešlu odpověď
  //   req.flush(resp);
  // });
  //
  ...
  //   const originalExperiment: Experiment<Output> = createEmptyExperiment();
  ...
  //   service.records.subscribe((experiments: Experiment<Output>[]) => {
  ...
  //   expect(service.update(updatedExperiment)).resolves.toBe(updatedExperiment);
  //
  //   // Založím nový požadavek
  //   const req: TestRequest = httpTestingController.expectOne(`${ExperimentsService.BASE_API_URL}`);
  ...
  //   // Přípravím si odpověď s namockovaným experimentem
  //   const resp: ResponseObject<Experiment<Output>> = { data: updatedExperiment };
  //   // Ručně odešlu odpověď
  //   req.flush(resp);
  // });
  //
  ...
  //   expect(originalExperiment.name).not.toBe(updatedExperiment.name);
  //   // Aktualizuji experiment pomocí service
  //   expect(service.update(updatedExperiment)).resolves.toBeUndefined();
  //
  //   // Založím nový požadavek
  //   const req: TestRequest = httpTestingController.expectOne(`${ExperimentsService.BASE_API_URL}`);
  //   // Požadavek bude typu PATCH
  ...
  //   expect(req.request.body).toBe(updatedExperiment);
  //   // Přípravím si odpověď s namockovaným experimentem
  //   const resp: ResponseObject<Experiment<Output>> = { message: { code: MessageCodes.CODE_ERROR_EXPERIMENT_NOT_FOUND } };
  //   // Ručně odešlu odpověď
  //   req.flush(resp);
  // });
  //
  ...
  //     expect(service.delete(experiment.id)).resolves.toBe(experiment);
  //
  //     // Založím nový požadavek
  //     const req: TestRequest = httpTestingController.expectOne(`${ExperimentsService.BASE_API_URL}/${experiment.id}`);
  //     // Požadavek bude typu PATCH
  ...
  //   expect(service.delete(2)).resolves.toBeUndefined();
  //
  //   // Založím nový požadavek
